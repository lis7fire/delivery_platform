...
public class SetmealVO extends Model<SetmealVO> {
    //主键
    private Long id;
    //菜品分类id
    ...
    //修改人
    private Long upLocalDateTimeUser;
    //是否删除
    ...
    public Long getUpLocalDateTimeUser() {
        return upLocalDateTimeUser;
    }

    public void setUpLocalDateTimeUser(Long upLocalDateTimeUser) {
        this.upLocalDateTimeUser = upLocalDateTimeUser;
    }
